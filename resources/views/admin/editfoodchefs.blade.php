...
<html lang="en">
  ...
  <body>
          ...
          <div style="position:relative; top:70px; left:70px; justify-content:space-between" class="d-flex">
                    <form action="{{url('/updatechef', $data->id)}}" class="form" method="post" enctype="multipart/form-data">
                            @csrf
                      <div class="form-group">
                        <label for="title">Chef Name</label>
                        <input value="{{$data->name}}" type="text" name="name" class="form-control" style="color:white" placeholder="Write a title" required>
                      </div>
                      <div class="form-group">
                        <label for="price">Chef Specialty</label>
                        <input value="{{$data->specialty}}" type="num" name="specialty" class="form-control" style="color:white" placeholder="Price" required>
                      </div>
                      <div class="form-group">
